...
class DeBERTa(torch.nn.Module):
  ...
  def forward(self, input_ids, attention_mask=None, token_type_ids=None, output_all_encoded_layers=True, position_ids = None, return_att = False, branch_type="normal", layer_id=0, total_layers=6):
    """
    Args:
      input_ids:
